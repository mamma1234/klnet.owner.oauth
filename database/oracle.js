...
async function init() {
  try {
      await oracledb.createPool({
          ...
          // connectString : "172.21.1.202:7527/ORAKLDB",
          // connectString : "172.19.1.103:7527/ORAKLDB",
          connectString : "(DESCRIPTION =(LOAD_BALANCE=OFF)(FAILOVER=ON)(ADDRESS_LIST = (ADDRESS = (PROTOCOL= TCP)(HOST= 172.19.1.103)(PORT=7527))(ADDRESS=(PROTOCOL=TCP)(HOST=172.19.1.103)(PORT= 7527)))(CONNECT_DATA =(SERVICE_NAME = ORAKLDB)(SERVER= DEDICATED)))",
          poolMax: 30,
          poolMin: 10,
          poolIncrement: 5,
          poolTimeout: 4
